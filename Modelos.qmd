---
title: "Fishe3r Scoringdd Algorithm ajustado2"
format: html
---
...
```
En la matriz de dispersión realizada se uso el coeficiente de correlación de Pearson, el cuál nos muestra que la mayoría de las variables tienen una alta correlación con la que será la variable respuesta, puntos realizados en la temporada (PTS).
